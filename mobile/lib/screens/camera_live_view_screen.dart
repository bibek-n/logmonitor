...
class _CameraLiveViewScreenState extends State<CameraLiveViewScreen> {
  ...
  Future<void> _start() async {
    try {
      ...
      // some mobile carriers) has no working candidate pair at all even though the server is
      // happy to relay for them.
      final pc = await createPeerConnection({
        "iceServers": [
          {"urls": "stun:stun.l.google.com:19302"},
          {
            "urls": "turn:202.166.217.58:3478?transport=udp",
            "username": "RQUKp1DR5X2u",
            "credential": "7yvM274siKNYC8C4STfetx0W",
          },
        ],
      });
      _pc = pc;
