...
const MODULE = AI_MODULES.alertCorrelation;

export default async function AlertCorrelationPage() {
  ...
  return (
    <div>
      ...
      {!isAiModulesConfigured() ? (
        ...
        <AiModuleChat
          apiEndpoint="/api/admin/ai-modules/alert-correlation/ask"
          exampleQuestions={MODULE.exampleQuestions}
          icon={<GitMerge size={14} />}
          placeholder="Ask which alerts might be related..."
        />
      )}
    </div>
  );
