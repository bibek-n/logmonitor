...
const MODULE = AI_MODULES.aiConfigurationReview;

export default async function AiConfigurationReviewPage() {
  ...
  return (
    <div>
      ...
      {!isAiModulesConfigured() ? (
        ...
        <AiModuleChat
          apiEndpoint="/api/admin/ai-modules/ai-configuration-review/ask"
          exampleQuestions={MODULE.exampleQuestions}
          icon={<ShieldQuestion size={14} />}
          placeholder="Which website or device should I review?"
        />
      )}
    </div>
  );
