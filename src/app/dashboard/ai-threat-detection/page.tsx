...
const MODULE = AI_MODULES.aiThreatDetection;

export default async function AiThreatDetectionPage() {
  ...
  return (
    <div>
      ...
      {!isAiModulesConfigured() ? (
        ...
        <AiModuleChat
          apiEndpoint="/api/admin/ai-modules/ai-threat-detection/ask"
          exampleQuestions={MODULE.exampleQuestions}
          icon={<Eye size={14} />}
          placeholder="What should I hunt for?"
        />
      )}
    </div>
  );
